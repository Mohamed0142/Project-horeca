...
<body class="text-gray-800">
    <div class="flex flex-col items-center justify-center min-h-screen">
        <div class="bg-white p-10 rounded-lg shadow-lg flex flex-col md:flex-row md:space-x-10">
            ...
            <form class="bg-white p-8 rounded-lg w-full md:w-1/2 max-w-lg shadow-md">
                ...
                <div class="mb-4">
                    ...
                    <input class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring focus:ring-yellow-200" type="text" id="phone" name="phone">
                </div>
                <div class="mb-4">
